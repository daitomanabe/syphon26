...
- `run_test_pattern_pair.sh`: bootstrap a temporary production XPC service and validate the Test Pattern server/client apps with expected frame-count, orientation, texture-opening, and passive-window gates.
